...
const ENT = {
  ...
  tilde: 732, ensp: 8194, emsp: 8195, thinsp: 8201, zwnj: 8204, zwj: 8205, lrm: 8206,
  ...
  oline: 8254, frasl: 8260, euro: 8364, trade: 8482, larr: 8592, uarr: 8593, rarr: 8594,
  darr: 8595, harr: 8596, infin: 8734, ne: 8800, le: 8804, ge: 8805,
  // Greek
...
function xhtmlBody(html, label) {
  ...
  if (bad) {
    ...
    throw new Error(`${label}: unmapped HTML entity ${names.map((n) => `&${n};`).join(", ")} — add to ENT in scripts/epub.mjs`);
  }
  return out;
}
